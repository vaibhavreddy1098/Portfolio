...
const skillsdata = [
  ...
  },
  {
    ...
    skills: ["Node.js", "React.js", "Bootstrap 5"],
  },
  {
...
const responsibilitiesdata = [
  {
    ...
    description:
      "Selected as a Core Team Member for the merged annual fest, leading the Publicity Team to promote the event.",
  },
  {
    role: "Core Team & Publicity Lead",
    event: "Wissenaire (Techno-Management Fest)",
    description:
      "Promoted to the Core Team and entrusted with leading the Publicity Team for the university's largest techno-management festival.",
  },
  {
    role: "Senior Member, Alumni Cell",
    event: "IIT Bhubaneswar",
    description:
      "Facilitated communication between alumni and the institute, leveraging networking skills to strengthen relations and organize initiatives.",
  },
];
const sociallinks = [
  {
    name: "GitHub",
    url: "https://github.com/vaibhavreddy1098",
  ...
  {
    name: "CodeChef",
    url: "https://www.codechef.com/users/vaibhavreddy01",
  ...
  {
    name: "Striver",
    url: "https://takeuforward.org/plus/profile/vaibhavreddy2006",
    ...
    if (chartref.current && window.Chart) {
      ...
      chartinstance = new window.Chart(ctx, {
        ...
        options: {
          ...
          plugins: {
            legend: { position: "top" },
            title: { display: true, text: "Energy Savings with DVFS" },
            tooltip: {
              callbacks: {
    ...
    <div className="container">
      ...
      <div className="collapse navbar-collapse" id="navbarNav">
        <ul className="navbar-nav ms-auto">
          ...
          <li className="nav-item">
            <a className="nav-link" href="#responsibilities">
              Responsibilities
            </a>
          </li>
          <li className="nav-item">
  ...
  >
    <div className="container">
      <img
        src="profile1.jpg"
        alt="Vaibhav Reddy"
        className="rounded-circle mx-auto mb-4 border border-4 border-white shadow-lg"
        style={{ width: "200px", height: "200px" }}
      />
      <h1 className="display-3 fw-bold">Vaibhav Reddy</h1>
      <p className="lead fs-4 text-muted mb-4">
        A B.Tech CSE student at IIT Bhubaneswar
      </p>
      <div>
    ...
    <div className="container">
      <div className="text-center mb-5">
        ...
        <p className="lead text-muted">
          A blend of academic rigor and hands-on leadership.
        </p>
      </div>
      <div className="row align-items-center">
        <div className="col-lg-7">
          <p className="mb-3">
            I am a passionate and driven Computer Science student at IIT
            Bhubaneswar, fascinated by the power of machine learning to solve
            complex problems. My current research focuses on making Large
            Language Models more energy-efficient, a challenge that combines
            deep technical analysis with real-world impact.
          </p>
          <p>
            As a dedicated problem solver, I have successfully solved over{" "}
            <strong className="text-primary">200+ DSA problems</strong> on
            Striver's A-Z DSA Sheet, strengthening my grasp of core algorithms
            and data structures. My goal is to leverage these skills to build
            products that are not only intelligent but also scalable,
            user-friendly, and efficient.
          </p>
        </div>
        <div className="col-lg-5">
          <div className="card text-center p-3 mb-3 shadow-sm">
            <h3 className="h5 mb-1">JEE Advanced 2023</h3>
            <p className="display-5 fw-bold text-primary">AIR 2243</p>
            <p className="text-muted small mb-0">out of ~200,000 students</p>
          </div>
          <div className="card text-center p-3 shadow-sm">
            <h3 className="h5 mb-1">JEE Mains 2023</h3>
            <p className="display-5 fw-bold text-primary">AIR 1480</p>
            <p className="text-muted small mb-0">
              out of ~1.5 million students
            </p>
          </div>
        </div>
      </div>
  ...
  <AnimatedSection id="projects" className="py-5 bg-white">
    <div className="container">
      <div className="text-center mb-5">
        ...
        <p className="lead text-muted">
          A selection of my work, from research to software development.
        </p>
      </div>
          ...
          <div className="col-lg-4 col-md-6" key={project.id}>
            ...
            >
              <div className="card-body d-flex flex-column">
                <h5 className="card-subtitle mb-2 text-primary text-uppercase small fw-bold">
                  {project.category}
                </h5>
...
const Skills = () => (
  <AnimatedSection id="skills" className="py-5">
    <div className="container">
      <div className="text-center mb-5">
        <h2 className="fw-bold">My Toolkit</h2>
        <p className="lead text-muted">
      ...
      <div className="row">
        {skillsdata.map((cat) => (
          <div className="col-lg-6 mb-4" key={cat.category}>
            <h3 className="h5 fw-bold mb-3">{cat.category}</h3>
            <div className="d-flex flex-wrap gap-2">
              {cat.skills.map((skill) => (
                <span
                  key={skill}
                  className="badge bg-light text-dark p-2 skill-badge"
                >
                  {skill}
                </span>
              ))}
          ...
          <div className="mt-4 d-flex justify-content-center gap-3">
            {sociallinks.map((link) => (
              <a
                ...
                className="d-inline-block text-decoration-none text-dark social-icon"
                title={link.name}
              >
...
const ProjectDetail = ({ projectid, onback }) => {
  ...
  return (
    <div className="container py-5">
      ...
      <div className="my-4 d-flex align-items-center flex-wrap gap-2">
        ...
        {project.liveDemo && (
          <a href={project.liveDemo} className="btn btn-primary btn-sm">
            Live Demo
          </a>
        )}
      </div>
      <div dangerouslySetInnerHTML={{ __html: project.content }} />
      {project.id === "llm-research" && (
        <div className="mt-4">
          <PowerSavingsChart />
        </div>
      )}
...
function App() {
  ...
  if (activeproject) {
    return (
      <ProjectDetail projectid={activeproject} onback={handlebacktoprojects} />
    );
  }
